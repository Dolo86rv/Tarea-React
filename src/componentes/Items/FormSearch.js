...
export const FormSearch = ({show}) => {
    ...
    return isShow ? (
        <div className="items-end"> 
           <form role="search" action="/resultados" method="get" autocomplete="off" className="flex items-center border border-turquee rounded-sm p-2">
              <Icons>
                 <img className="cursor-pointer transform" src= {lupa} width="13" height="13" alt='search'></img>
              </Icons>
              <div className="flex">
                 <input type="text" value="" id="header-search" placeholder="Buscar" name="s" className="text-sm bg-transparent p-1"></input>
                 <Icons>
